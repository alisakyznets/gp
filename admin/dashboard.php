...
SELECT a.*, u.fio, c.category, s.status
...
SELECT user_id, fio, login, email
...
<td><a href="../application-detail.php?id=<?= $app['application_id'] ?>"><?= escape($app['title']) ?></a></td>

<td><?= escape($app['fio']) ?></td>

<td><span class="status-badge <?= strtolower(str_replace(' ', '-', $app['status'])) ?>"><?= escape($app['status']) ?></span></td>
